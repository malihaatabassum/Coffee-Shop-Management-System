...
public class FileReadWriteDemo
{
  ...
  private BufferedReader bfr;   //to read file content  
   ...
   public void writeInFile(String x,int y,String z,String w,String q)
  {
    /*
    ...
    */
    try
    {
      file = new File("Customer History.txt");  //Declaring a file named named File.txt for creating.
      ...
      writer.write("Customer Name- "+x+"      Customer ID- "+y+"      Customer Phone Number- "+z+"      Customer Email- "+w+"      Customer Adress- "+q+"\r"+"\n"+"\n");   //writing string a,c & int b in the file. the "\r" and "\n" has been concat to go to a newline.
